package com.quanify.sensors;

import android.bluetooth.BluetoothGattCharacteristic;

public class Temperature {
	private static Temperature  singleTemp= new Temperature();
	...
	public double extractAmbientTemperature(BluetoothGattCharacteristic c) {
	    int offset = 2;
	    return shortUnsignedAtOffset(c, offset) / 128.0;
	}

	public double extractTargetTemperature(BluetoothGattCharacteristic c, double ambient) {
