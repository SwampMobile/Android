...
import com.quanify.app.ImpactGraphSingleton;
...
public class ImpactFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		graphView.addSeries(ImpactGraphSingleton.getInstance().getExampleSeries()); 
		graphView.addSeries(ImpactGraphSingleton.getInstance().getMaxSeries());		
		...
		ImpactGraphSingleton.clearGraph();
		ImpactGraphSingleton.getInstance().startgraph();
		return fl;
	}
