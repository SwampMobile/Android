...
public class DeviceList 
{
	...
	public void addDevice(Context context, BluetoothDevice device, PropertyChangeListener listener, int rssi) {
		if(!deviceMap.containsKey(device.getAddress()) && device.getName().startsWith("Sensor")) {
